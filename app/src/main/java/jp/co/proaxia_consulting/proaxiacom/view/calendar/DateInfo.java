...
import jp.co.proaxia_consulting.proaxiacom.util.HolidayUtil;
import jp.co.proaxia_consulting.proaxiacom.util.StrUtil;
...
public class DateInfo implements Parcelable {
    ...
    public DateInfo(int year, int month, int day) {
        ...
        //DBからイベントを取得
        dbAdapter = new DBAdapter(DBAdapter.context);
        this.eventName = dbAdapter.getEventName(this.getYMD());
